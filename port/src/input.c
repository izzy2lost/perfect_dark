...
#ifdef ANDROID
	// Fold in the on-screen controller. This runs before the gamepad section so that a
	// physical pad only fills in axes the touch overlay is not currently deflecting.
